document.addEventListener('DOMContentLoaded', function() {
	...
	function showContent() {
		const bodyElements = ['body', 'home', 'body2', 'mock-up-button'];
	...
	function setLinksWidthAndPadding() {
		...
		linksContainer.style.padding = isZoomedOut ? '0' : '';
	}
	...
	function scrollToTop() {
		...
		// Show main content after scrolling
		showMainContent();
	}
